...
oPaginate:{sFirst:"اولین",sLast:"آخرین",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"اطلاعاتی برای نمایش وجود ندارد",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ رکورد",sInfoEmpty:"نمایش 0 تا 0 از 0 رکورد",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ رکورد",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"نتیجه مرتبطی یافت نشد"},oSearch:h.extend({},
